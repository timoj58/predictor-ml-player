...
def create_feature_columns(player_vocab, player_vocab_count, team_vocab, team_vocab_count):
 ...
 feature_columns.append(create_category_indicator_column('home', team_vocab, team_vocab_count))
 ...
 crossed_home_players = tf.feature_column.crossed_column(
 ...
 feature_columns.append(tf.feature_column.indicator_column(crossed_home_players))
 ...
 # Cross the bucketized columns, using 5000 hash bins.
 crossed_home_subs = tf.feature_column.crossed_column(
  [home_sub1_fc, home_sub2_fc, home_sub3_fc], 5000)

 feature_columns.append(tf.feature_column.indicator_column(crossed_home_subs))

 feature_columns.append(create_category_indicator_column('away', team_vocab, team_vocab_count))
 ...
 # Cross the bucketized columns, using 5000 hash bins.
 crossed_away_players = tf.feature_column.crossed_column(
 ...
 feature_columns.append(tf.feature_column.indicator_column(crossed_away_players))
 ...
 # Cross the bucketized columns, using 5000 hash bins.
 crossed_away_subs = tf.feature_column.crossed_column(
  [away_sub1_fc, away_sub2_fc, away_sub3_fc], 5000)

 feature_columns.append(tf.feature_column.indicator_column(crossed_away_subs))
