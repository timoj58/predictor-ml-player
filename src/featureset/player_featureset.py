...
def create_feature_columns(player_vocab, player_vocab_count, team_vocab, team_vocab_count):
    ...
    feature_columns.append(featureset_utils.create_category_indicator_column('player', player_vocab, player_vocab_count))
    ...
    feature_columns.append(tf.feature_column.numeric_column(key='price'))
