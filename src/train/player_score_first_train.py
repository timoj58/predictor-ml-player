...
history_file = get_dir_cfg()['players_first_goal_train_history_file']
...
def process(type, country, player):
    ...
    learning_cfg = get_learning_cfg('player', 'player_first_goal')
    ...
    training_utils.train_player(
        ...
        player=player,
        range=range,
        filename_prefix="player-first-goal",
        label='firstGoal',
        model_dir="player_first_goal",
